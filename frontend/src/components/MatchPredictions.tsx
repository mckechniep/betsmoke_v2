...
function ProbabilityBar({ label, value, color = 'blue', showPercentage = true }: ProbabilityBarProps) {
...
function ThreeWayProbability({
  ...
  drawLabel = 'Draw',
  awayLabel = 'Away'
}: ThreeWayProbabilityProps) {
  return (
    <div className="grid grid-cols-3 gap-4 text-center">
      <div className="bg-blue-900/30 rounded-lg p-3">
        <div className="text-2xl font-bold text-blue-400">{Number(home).toFixed(1)}%</div>
        <div className="text-xs text-gray-400 mt-1">{homeLabel}</div>
      </div>
      <div className="bg-gray-700 rounded-lg p-3">
        <div className="text-2xl font-bold text-gray-300">{Number(draw).toFixed(1)}%</div>
        <div className="text-xs text-gray-400 mt-1">{drawLabel}</div>
      </div>
      <div className="bg-red-900/30 rounded-lg p-3">
        <div className="text-2xl font-bold text-red-400">{Number(away).toFixed(1)}%</div>
...
function YesNoProbability({ yes, no, yesLabel = 'Yes', noLabel = 'No' }: YesNoProbabilityProps) {
  return (
    <div className="grid grid-cols-2 gap-4 text-center">
      <div className="bg-green-900/30 rounded-lg p-3">
        <div className="text-2xl font-bold text-green-400">{Number(yes).toFixed(1)}%</div>
        <div className="text-xs text-gray-400 mt-1">{yesLabel}</div>
      </div>
      <div className="bg-red-900/30 rounded-lg p-3">
        <div className="text-2xl font-bold text-red-400">{Number(no).toFixed(1)}%</div>
...
// ============================================
function MatchResultSection({ predictions, homeTeam, awayTeam }: MatchSectionProps) {
...
// GOALS SECTION
// ============================================
function GoalsSection({ predictions, homeTeam, awayTeam }: MatchSectionProps) {
...
// TEAM GOALS SECTION
// ============================================
function TeamGoalsSection({ predictions, homeTeam, awayTeam }: MatchSectionProps) {
...
// ============================================
function CorrectScoreSection({ predictions, homeTeam, awayTeam }: MatchSectionProps) {
  ...
  const sortedScores = Object.entries(scores)
    ...
    .map(([score, probability]) => ({ score, probability: parseFloat(String(probability)) }))
...
// CORNERS SECTION
// ============================================
function CornersSection({ predictions }: PredictionsOnlyProps) {
...
// ============================================
function HalfTimeFullTimeSection({ predictions, homeTeam, awayTeam }: MatchSectionProps) {
