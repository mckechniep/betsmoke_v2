...
const AccountSettings = () => {
  ...
  useEffect(() => {
    try {
      const tzList = (Intl as any).supportedValuesOf?.('timeZone') as string[] | undefined;
  ...
  const handleUpdateSecurityQuestion = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setSecurityError('');
    setSecuritySuccess('');
    ...
    try {
      ...
      setSecurityError(getErrorMessage(err, 'Failed to update security question'));
    } finally {
