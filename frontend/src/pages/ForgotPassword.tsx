...
const ForgotPassword = () => {
  ...
  const handleEmailReset = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setError('');
    setSuccess('');
    setLoading(true);
  ...
  const handleTrySecurityQuestion = async () => {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'No security question found for this account'));
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleVerifySecurityAnswer = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setError('');
    setLoading(true);
    ...
    try {
      ...
      setError(getErrorMessage(err, 'Incorrect answer. Please try again.'));
    } finally {
      setLoading(false);
    }
  };
